...
const HeroPageDescr: React.FC<IHeroPageDescr> = ({
  affiliation,
  birthday,
  constellation,
  description,
    ...
    <>
      <div className={styles.descr}>
        ...
        <div className={styles.vision}>
          Vision: {vision}
          <img className={styles.visionImg} src={visionImg} />
        </div>
        <div className={styles.weapon}>Weapon: {weapon}</div>
        <div className={styles.weapon_type}>Weapon_type: {weapon_type}</div>
      </div>
    </>
  )
}
