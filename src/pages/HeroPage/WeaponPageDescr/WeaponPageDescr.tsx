...
const  WeaponPageDescr: React.FC<IWeaponPageDescr> = ({ ascensionMaterial,baseAttack,location,name,passiveDesc,passiveName,rarity,subStat,type, rarityImg }) => {

  return(
    <>
      <div className={styles.WeaponPageDescr}>
        <div 
          className={ascensionMaterial}>
          <div 
            className={styles.ascensionMaterial}>
            AscensionMaterial: {ascensionMaterial}
          </div>
          <div 
            className={styles.baseAttack}>
          ...
          <div 
            className={styles.passiveDesc}>
            PassiveDesc: {passiveDesc}
          </div>
          <div 
            className={styles.passiveName}>
